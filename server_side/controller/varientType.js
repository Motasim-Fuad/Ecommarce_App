...
exports.getAllVarientType = asyncHandler(async (req, res) => {
    try {
...
exports.getVarientTypeByID = asyncHandler(async (req, res) => {
    try {
...
exports.createVarientType = asyncHandler(async (req, res) => {
...
exports.updateVarientType = asyncHandler(async (req, res) => {
    const variantTypeID = req.params.id;
    const { name ,type } = req.body;
    if (!name) {
        return res.status(400).json({ success: false, message: "Name is required." });
...
exports.deleteVarientType = asyncHandler(async (req, res) => {
    const variantTypeID = req.params.id;
    try {
