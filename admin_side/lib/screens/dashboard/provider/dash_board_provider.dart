  ...
  addProduct()async{
    try{
      if(selectedMainImage == null){
        SnackBarHelper.showErrorSnackBar("Please Chouse a Images");
        return;
      }
      ...
      if(response.isOk){
        ...
        if(apiResponse.success ==true){
          ...
          _dataProvider.getAllProduct(); //List a data show korar jonno , jokon update korbo
    ...
    try{
      ...
      if(response.isOk){
        ...
        if(apiResponse.success ==true){
          ...
          _dataProvider.getAllProduct(); //List a data show korar jonno , jokon delete korbo
